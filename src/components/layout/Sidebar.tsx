                        ...
                        <div className="space-y-6">
                          ...
                          {config.type === 'bokeh' && (
                            <div className="space-y-4 pt-4 border-t border-black/5 dark:border-white/5">
                              <label className="text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300 block mb-2">
                                Specific Controls
                                <span className="ml-2 text-indigo-500 dark:text-indigo-400">BOKEH</span>
                              </label>
                              ...
                              <div className="space-y-3">
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    <span>Shape</span>
                                    <span className="text-indigo-500 dark:text-indigo-400 capitalize">{config.customSettings?.shape || 'circle'}</span>
                                  </div>
                                  <div className="grid grid-cols-3 gap-1 bg-black/5 dark:bg-white/5 p-1 rounded-xl border border-black/10 dark:border-white/10">
                                    {(['circle', 'hexagon', 'square'] as const).map((s) => (
                                      <button
                                        key={s}
                                        onClick={() => setConfig({ 
                                          ...config, 
                                        ...
                                        className={cn(
                                          "py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-all",
                                          (config.customSettings?.shape || 'circle') === s 
                                            ? "bg-indigo-600 text-white shadow-lg shadow-indigo-500/20" 
                                            : "text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-200 hover:bg-black/5 dark:hover:bg-white/5"
                                        )}
                                      >
                                ...
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    ...
                                    <span className="text-indigo-500 dark:text-indigo-400">{((config.customSettings?.focusPlane ?? 0.5) * 100).toFixed(0)}%</span>
                                  </div>
                                  <input 
                                    type="range" min="0" max="1" step="0.01"
                                    value={config.customSettings?.focusPlane ?? 0.5}
                                    onChange={(e) => setConfig({ 
                                      ...config, 
                                      customSettings: { ...config.customSettings, focusPlane: parseFloat(e.target.value) } 
                                    })}
                                    className="w-full h-1 bg-black/10 dark:bg-white/10 rounded-lg appearance-none cursor-pointer accent-indigo-600"
                                  />
                                </div>
                                ...
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    <span>Aperture</span>
                                    <span className="text-indigo-500 dark:text-indigo-400">{((config.customSettings?.aperture ?? 0.2) * 100).toFixed(0)}%</span>
                                  </div>
                                  <input 
                                    type="range" min="0" max="1" step="0.01"
                                    value={config.customSettings?.aperture ?? 0.2}
                                    onChange={(e) => setConfig({ 
                                      ...config, 
                                      customSettings: { ...config.customSettings, aperture: parseFloat(e.target.value) } 
                                    })}
                                    className="w-full h-1 bg-black/10 dark:bg-white/10 rounded-lg appearance-none cursor-pointer accent-indigo-600"
                                  />
                                </div>
                                ...
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    <span>Glow</span>
                                    <span className="text-indigo-500 dark:text-indigo-400">{((config.customSettings?.glow ?? 0.8) * 100).toFixed(0)}%</span>
                                  </div>
                                  <input 
                                    type="range" min="0" max="2" step="0.1"
                                    value={config.customSettings?.glow ?? 0.8}
                                    onChange={(e) => setConfig({ 
                                      ...config, 
                                      customSettings: { ...config.customSettings, glow: parseFloat(e.target.value) } 
                                    })}
                                    className="w-full h-1 bg-black/10 dark:bg-white/10 rounded-lg appearance-none cursor-pointer accent-indigo-600"
                                  />
                                </div>
                          ...
                          {config.type === 'avatars' && (
                            <div className="space-y-4 pt-4 border-t border-black/5 dark:border-white/5">
                              <label className="text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300 block mb-2">
                                Specific Controls
                                <span className="ml-2 text-indigo-500 dark:text-indigo-400">AVATARS</span>
                              </label>
                              ...
                              <div className="space-y-3">
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    <span>Icon Type</span>
                                    <span className="text-indigo-500 dark:text-indigo-400 capitalize">{config.customSettings?.iconType || 'user'}</span>
                                  </div>
                                  <div className="grid grid-cols-4 gap-1 bg-black/5 dark:bg-white/5 p-1 rounded-xl border border-black/10 dark:border-white/10">
                                    {(['user', 'heart', 'star', 'zap', 'ghost', 'smile', 'coffee', 'camera'] as const).map((s) => (
                                      <button
                                        key={s}
                                        onClick={() => setConfig({ 
                                          ...config, 
                                          customSettings: { ...config.customSettings, iconType: s } 
                                        })}
                                        className={cn(
                                          "py-1.5 rounded-lg text-[8px] font-bold uppercase tracking-wider transition-all",
                                          (config.customSettings?.iconType || 'user') === s 
                                            ? "bg-indigo-600 text-white shadow-lg shadow-indigo-500/20" 
                                            : "text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-200 hover:bg-black/5 dark:hover:bg-white/5"
                                        )}
                                      >
                                ...
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    <span>Blur</span>
                                    <span className="text-indigo-500 dark:text-indigo-400">{config.customSettings?.blur ?? 10}px</span>
                                  </div>
                                  <input 
                                    type="range" min="0" max="40" step="1"
                                    value={config.customSettings?.blur ?? 10}
                                    onChange={(e) => setConfig({ 
                                      ...config, 
                                      customSettings: { ...config.customSettings, blur: parseInt(e.target.value) } 
                                    })}
                                ...
                                <div className="space-y-2">
                                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-neutral-700 dark:text-neutral-300">
                                    ...
                                    <span className="text-indigo-500 dark:text-indigo-400">{((config.customSettings?.frost ?? 0.2) * 100).toFixed(0)}%</span>
                                  </div>
                                  <input 
                                    type="range" min="0" max="1" step="0.05"
                                    value={config.customSettings?.frost ?? 0.2}
                                    onChange={(e) => setConfig({ 
                                      ...config, 
                                      customSettings: { ...config.customSettings, frost: parseFloat(e.target.value) } 
                                    })}
                                    className="w-full h-1 bg-black/10 dark:bg-white/10 rounded-lg appearance-none cursor-pointer accent-indigo-600"
                                  />
                                </div>
